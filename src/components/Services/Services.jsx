        ...
        <div className={styles.services}>
            ...
            <ul className={styles.servicesList}>
                ...
                <li className={styles.serviceCard}>
                    ...
                    <p className={styles.serviceDescription}>
                        Photo and video production, editing, and creating unique content for your brand. Development of
                        ideas that
                ...
                <li className={styles.serviceCard}>
                    ...
                    <p className={styles.serviceDescription}>
                        Content planning, creating a content calendar, text editing, and coordinating publications to
                        ensure
                        smooth
